            ...
            {main.map((menu, i) => (
              <React.Fragment key={`menu-${i}`}>
                {menu.hasChildren ? (
                  ...
                  onMouseEnter={() => setDropdownVisible(i)}
                  ...
                  dropdownVisible === i ? "visible" : ""
                } hidden w-full overflow-hidden border border-border-secondary py-0 transition-all duration-500 group-hover:block group-hover:py-2 lg:invisible lg:absolute lg:left-1/2 lg:block lg:w-auto lg:-translate-x-1/2 lg:group-hover:visible lg:group-hover:opacity-100`}>
